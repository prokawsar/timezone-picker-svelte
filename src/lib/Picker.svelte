<script>
	...
	import groupedZones from './timezones.js'
	import { scrollIntoView, uid, slugify, keyCodes, ungroup, filter, pick } from './utils.js'
...
<style>
	...
	li[aria-selected='true'] {
		background: var(--color-info-900, #f1f5f9);
		cursor: pointer;
	...
	input:focus {
		border: 1.5px solid var(--color-gray-400, #acacac);
		outline: none;
	}
